 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./football_god_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the football_god_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./football_god_backend.did.js")._SERVICE>}
 */
export const football_god_backend = createActor(canisterId);
