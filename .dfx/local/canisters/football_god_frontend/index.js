...
import { idlFactory } from './football_god_frontend.did.js';
export { idlFactory } from './football_god_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FOOTBALL_GOD_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./football_god_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the football_god_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./football_god_frontend.did.js")._SERVICE>}
 */
export const football_god_frontend = createActor(canisterId);
