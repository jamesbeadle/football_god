...
const Ks = new RegExp(/^[0-9a-fA-F]+$/);
function ce(e) {
  if (!Ks.test(e)) throw new Error("Invalid hexadecimal string.");
  const t = [...e]
...
function zs(e, t) {
  return e.byteLength < t && ti(), e.read(t);
}
function un(e) {
  const t = e.readUint8();
  return t === void 0 && ti(), t;
}
function cn(e) {
...
let Xs = class Br {
  ...
  encodeCBOR(t) {
    return t._pushInt(this.value, Js.SIMPLE_FLOAT);
  }
  static isSimple(t) {
...
var fi = {
  URLWithLegacySupport: Zs,
  URLSearchParams: self.URLSearchParams,
  defaultBase: ci,
  format: Qs,
};
const { URLWithLegacySupport: hn, format: to } = fi;
var eo = (e, t = {}, r = {}, o) => {
...
let Ur = class Nr {
  ...
  createInt64Neg(t, r, o, u) {
    ...
    return d > It.MAX_SAFE_HIGH
      ? It.NEG_ONE.minus(new ao(d).times(It.SHIFT32).plus(g))
      : -1 - (d * It.SHIFT32 + g);
  }
  createTrue() {
    return !0;
...
class Kr extends lo {
  ...
  createFloat(t) {
    ...
    return po.isNegativeZero(t) ? "-0_1" : `${r}_1`;
  }
  createFloatSingle(t, r, o, u) {
...
const { Buffer: Vt } = Oe,
  ...
  wn = Lt.SYMS,
  ge = Lt.TAG,
  go = (Lt.MT.SIMPLE_FLOAT << 5) | Lt.NUMBYTES.TWO,
  xo = (Lt.MT.SIMPLE_FLOAT << 5) | Lt.NUMBYTES.FOUR,
  mo = (Lt.MT.SIMPLE_FLOAT << 5) | Lt.NUMBYTES.EIGHT,
  bo = (Lt.MT.SIMPLE_FLOAT << 5) | Lt.SIMPLE.TRUE,
  Eo = (Lt.MT.SIMPLE_FLOAT << 5) | Lt.SIMPLE.FALSE,
  _o = (Lt.MT.SIMPLE_FLOAT << 5) | Lt.SIMPLE.UNDEFINED,
  yn = (Lt.MT.SIMPLE_FLOAT << 5) | Lt.SIMPLE.NULL,
  Io = new Fr("0x20000000000000"),
  Ao = Vt.from("f97e00", "hex"),
  Bo = Vt.from("f9fc00", "hex"),
  So = Vt.from("f97c00", "hex");
function To(e) {
...
class Xe {
  ...
  _pushFloat(t) {
    ...
    if (hr.writeHalf(r, t) && hr.parseHalf(r) === t)
      return this._pushUInt8(go) && this.push(r);
    const o = Vt.allocUnsafe(4);
    return (
      o.writeFloatBE(t, 0),
      o.readFloatBE(0) === t
        ? this._pushUInt8(xo) && this.push(o)
        : this._pushUInt8(mo) && this._pushDoubleBE(t)
    );
  }
  _pushInt(t, r, o) {
    const u = r << 5;
  ...
  _pushBoolean(t) {
    return this._pushUInt8(t ? bo : Eo);
  }
  _pushUndefined(t) {
    return this._pushUInt8(_o);
  }
  _pushArray(t, r) {
    const o = r.length;
...
function He(e) {
  if (e instanceof di.Tagged) return He(e.value);
...
const t0 = (e, t) => {
  ...
  const o = (c, b) => {
    ...
    u = new Uint8Array(e);
  if (
    (o(48, "sequence"), (r += Or(u, r)), !Zn(u.slice(r, r + t.byteLength), t))
  )
  ...
  static from(t) {
    if (typeof t == "string") {
      ...
      if (ArrayBuffer.isView(r)) {
        const o = r;
        return this.fromRaw(Qn(o.buffer));
      } else {
...
class ae extends Yr {
  ...
  static generate(t) {
    ...
    t || (t = Se.utils.randomPrivateKey()),
      Zn(t, new Uint8Array(new Array(32).fill(0))) &&
        console.warn(
