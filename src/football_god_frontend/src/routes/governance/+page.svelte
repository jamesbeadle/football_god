...
<Layout>
  {#if isLoading}
    <Spinner />
  {:else}
    <div class="relative bg-gray-800 text-white mt-2 mr-2 rounded-lg p-4">
      <p class="text-xl">FootballGod Governance</p>
      <p class="mt-4">
        FootballGod will become the entry point for users to manage data with the OpenFPL ecosystem.
      </p>
      <p class="mt-2">
        ...
        {#if activeTab === "proposals"}
          ...
          <div class="flex justify-center items-center mt-4 mb-4">
            <button
              ...
              class={`brand-button disabled:bg-gray-400 disabled:text-gray-700 disabled:cursor-not-allowed min-w-[100px] default-button`}
          >
              Previous
          </button>
