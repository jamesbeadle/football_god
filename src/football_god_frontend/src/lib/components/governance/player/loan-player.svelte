<script lang="ts">
  ...
  import type { ClubDTO, FootballLeagueDTO, LoanPlayerDTO, PlayerDTO } from "../../../../../../declarations/football_god_backend/football_god_backend.did";
  ...
  onMount(async () => {
    try {
      ...
      toastsError({
        msg: { text: "Error mounting loan player modal." },
        err: error,
      });
