<div class="m-4">
  ...
  <p class="my-4">
    FootballGod will provide a much needed fixed-odds betting
  ...
  <p class="my-4">
    FootballGod will provide this service using the DAO's deflationary utility
  ...
  <p class="my-4">
    <b>Until a UK gambling license is aquired by the founding team, no $FOOTBALL token will be released.</b>
  </p>
  ...
  <p class="my-4 default-header">The Future</p>
  <p class="my-4">
    After regulatory requirements are met, FootballGod will function entirely on-chain, aspiring to operate under the
    ...
    the spread of odds offered on the platform.
  </p>

  <p class="my-4">
    We aim to phase in difference markets, mini games and features as the
