...
const Play = () => {
  ...
  const submitScores = async (enterSweepstake) => {
    ...
    setIsLoading(false);
    navigate(
      `/view-prediction/${viewData.userId}/${viewData.activeSeasonId}/${viewData.activeGameweekNumber}`
    );
  };
                ...
                >
                  ...
                  {viewData.fixtures.map((fixture) => (
                    ...
                    >
                      <Col xs={4} className="text-center button-column">
                        <Form.Group className="w-100 d-flex flex-column">
                          <Button
                            ...
                            onClick={() =>
                              incrementScore(fixture.fixtureId, "home")
                            }
                            style={{
                              width: "100%",
                              padding: "0",
                          ...
                          <Form.Control
                            ...
                            onChange={(event) =>
                              handleChange(event, fixture.fixtureId, "home")
                            }
                          ...
                          <Button
                            className="custom-button"
                            onClick={() =>
                              decrementScore(fixture.fixtureId, "home")
                            }
                            style={{
                              width: "100%",
                              padding: "0",
                      ...
                      <Col
                        xs={4}
                        className="text-center d-flex align-items-center justify-content-center flex-column column-border"
                      >
                      ...
                      <Col xs={4} className="text-center button-column">
                        <Form.Group className="w-100 d-flex flex-column">
                          <Button
                            className="custom-button"
                            onClick={() =>
                              incrementScore(fixture.fixtureId, "away")
                            }
                            style={{
                              width: "100%",
                              padding: "0",
                          ...
                          <Form.Control
                            ...
                            onChange={(event) =>
                              handleChange(event, fixture.fixtureId, "away")
                            }
                            className="d-block mx-auto custom-number-input w-100 custom-input readonly-input"
                            readOnly
                          />
                          <Button
                            className="custom-button"
                            onClick={() =>
                              decrementScore(fixture.fixtureId, "away")
                            }
                            style={{
                              width: "100%",
                              padding: "0",
                  ...
                  <div className="text-center">
                    ...
                    {viewData.sweepstakePaid ? (
                      <p className="mt-2">
                        You have already paid for the sweepstake.
                      </p>
                    ) : loadingAccountBalance ? (
                      <div className="d-flex flex-column align-items-center justify-content-center mt-3">
                        <Spinner animation="border" />
                        <p className="text-center mt-1">
                          <small>Checking Account Balance</small>
                        </p>
                      </div>
                    ) : (
                      <div className="mt-2">
                        {Number(balanceData.accountBalance) / 1e8 >= 1 ? (
                          ...
                          >
                            Save & Enter Sweepstake - 1 ICP
                          </Button>
                        ) : (
                          <p>
                            You do not have enough ICP to enter the sweepstake.
                          </p>
                        )}
                      </div>
                    )}
