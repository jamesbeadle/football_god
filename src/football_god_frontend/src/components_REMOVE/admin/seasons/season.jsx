...
const Season = () => {
  ...
  const fetchGameweeks = async () => {
    const gameweeksData = await football_god_backend_actor.getGameweeks(
      Number(seasonId)
    );
  ...
  const submitUpdateGameweekStatus = async (event) => {
    ...
    await football_god_backend_actor.updateGameweekStatus(
      Number(seasonId),
      Number(updatedGameweek),
                        ...
                        <td>
                          <Dropdown alignRight className="custom-dropdown">
                            ...
                            <Dropdown.Menu>
                              <Dropdown.Item
                                href="#"
                                onClick={() => updateStatus(gameweek)}
                              >
                                Update Status
                              </Dropdown.Item>
                              <LinkContainer
                                to={`/fixtures/${seasonId}/${gameweek.number}`}
                              >
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={submitUpdateGameweekStatus}
          >
            Save
          </Button>
        </Modal.Footer>
