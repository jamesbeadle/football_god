...
const SystemStateModal = ({
  ...
  const handleSubmit = async (event) => {
    ...
    await football_god_backend_actor.setSystemState(
      Number(activeSeasonId),
      Number(activeGameweekNumber)
    );
      ...
      <Modal.Body>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group controlId="seasonYear">
            ...
            <Form.Control
              as="select"
              value={activeGameweekNumber}
              onChange={(e) => setActiveGameweekNumber(e.target.value)}
            >
