...
import Debug "mo:base/Debug";
  ...
  actor Self {
    ...
    public shared query ( {caller} ) func getLoanedPlayers(leagueId: FootballTypes.LeagueId, dto: RequestDTOs.ClubFilterDTO) : async Result.Result<[ResponseDTOs.PlayerDTO], T.Error>{
      assert callerAllowed(caller);
      ...
      switch(filteredLeaguePlayers){
        case (?foundLeaguePlayers){             
          ...
          return #ok(Array.map<FootballTypes.Player, ResponseDTOs.PlayerDTO>(loanedClubPlayers, func(player: FootballTypes.Player){
        ...
        case (?foundPlayers){
          ...
          switch(playerResult){
            case (?foundPlayer){
              ...
              let _ = updateDataHashes(dto.leagueId, "players");
              return #ok();
            };
            case (null){
    ...
    public shared ({ caller }) func moveFixture(dto : GovernanceDTOs.MoveFixtureDTO) : async Result.Result<(), T.Error> {
      ...
      let _ = updateDataHashes(dto.leagueId, "fixtures");
      return #ok();
    };
    ...
    public shared ({ caller }) func promoteClub(leagueId: FootballTypes.LeagueId, dto : GovernanceDTOs.PromoteClubDTO) : async Result.Result<(), T.Error> {
      ...
      let _ = updateDataHashes(leagueId, "clubs");
        return #ok();
        */
                ...
                if(season.id == leagueStatus.activeSeasonId){              
                  return {
                    fixtures = List.map<FootballTypes.Fixture, FootballTypes.Fixture>(season.fixtures, func(fixture: FootballTypes.Fixture){
                      ...
                      if(fixture.status == #Unplayed and now <= fixtureEndTime){
                        return {
                          awayClubId = fixture.awayClubId;
                          awayGoals = fixture.awayGoals;
                          events = fixture.events;
                ...
                if(season.id == leagueStatus.activeSeasonId){              
                  return {
                    fixtures = List.map<FootballTypes.Fixture, FootballTypes.Fixture>(season.fixtures, func(fixture: FootballTypes.Fixture){
                      ...
                      if(fixture.status == #Active and now > fixtureEndTime){
                        return {
                          awayClubId = fixture.awayClubId;
                          awayGoals = fixture.awayGoals;
                          events = fixture.events;
    ...
    private func setupTesting(){
      ...
      if(Array.size(leagueSeasons) > 0){
        return;
      };

      if(Array.size(leagueClubs) > 0){
        return;
      };
