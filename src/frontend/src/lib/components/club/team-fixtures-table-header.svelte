<div class="flex items-center px-4 py-4 text-white border-b border-gray-700 bg-BrandLightGray">
    ...
    <div class="flex-grow w-1/4 pl-2">Date</div>
    <div class="flex-grow hidden w-1/6 text-center md:flex">Time</div>
    <div class="flex-grow w-1/6 text-center md:w-1/4">Result</div>
</div>