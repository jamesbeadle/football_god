...
export interface ClubValueLeaderboard { 'clubs' : Array<ClubSummary> }
export interface Clubs { 'clubs' : Array<Club>, 'leagueId' : LeagueId }
export interface Countries { 'countries' : Array<Country> }
export interface Country { 'id' : CountryId, 'code' : string, 'name' : string }
export type CountryId = number;
export interface DataHash { 'hash' : string, 'category' : string }
export interface DataHashes { 'dataHashes' : Array<DataHash> }
...
export interface GetClubs { 'leagueId' : LeagueId }
export type GetCountries = {};
export interface GetDataHashes { 'leagueId' : LeagueId }
export type GetDataTotals = {};
export interface GetFixtures { 'seasonId' : SeasonId, 'leagueId' : LeagueId }
export interface GetLeagueStatus { 'leagueId' : LeagueId }
export type GetLeagues = {};
export interface GetLoanedPlayers { 'leagueId' : LeagueId }
export type GetPlayerValueLeaderboard = {};
export interface GetPlayers { 'leagueId' : LeagueId }
export interface GetPostponedFixtures { 'leagueId' : LeagueId }
export interface GetSeasons { 'leagueId' : LeagueId }
...
export interface Leagues { 'leagues' : Array<League> }
export interface LoanedPlayers { 'players' : Array<Player> }
...
export interface PlayerValueLeaderboard { 'players' : Array<PlayerSummary> }
export interface Players { 'players' : Array<Player> }
...
export type Result = { 'ok' : null } |
  { 'err' : Error };
export type Result_1 = { 'ok' : Seasons } |
  { 'err' : Error };
export type Result_10 = { 'ok' : DataTotals } |
  { 'err' : Error };
export type Result_11 = { 'ok' : DataHashes } |
  { 'err' : Error };
export type Result_12 = { 'ok' : Countries } |
  { 'err' : Error };
export type Result_13 = { 'ok' : Clubs } |
  { 'err' : Error };
export type Result_14 = { 'ok' : ClubValueLeaderboard } |
  { 'err' : Error };
export type Result_15 = { 'ok' : AppStatus } |
  { 'err' : Error };
export type Result_2 = { 'ok' : ProjectCanisters } |
  { 'err' : Error };
export type Result_3 = { 'ok' : PostponedFixtures } |
  { 'err' : Error };
export type Result_4 = { 'ok' : Players } |
  { 'err' : Error };
export type Result_5 = { 'ok' : PlayerValueLeaderboard } |
  { 'err' : Error };
export type Result_6 = { 'ok' : LoanedPlayers } |
  { 'err' : Error };
export type Result_7 = { 'ok' : Leagues } |
  { 'err' : Error };
export type Result_8 = { 'ok' : LeagueStatus } |
  { 'err' : Error };
export type Result_9 = { 'ok' : Fixtures } |
  { 'err' : Error };
export interface Season { 'id' : number, 'name' : string, 'year' : number }
export type SeasonId = number;
export interface Seasons { 'seasons' : Array<Season> }
...
export interface _SERVICE {
  ...
  'getPlayerValueLeaderboard' : ActorMethod<
