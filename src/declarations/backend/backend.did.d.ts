...
export type BetType = { 'SevenFold' : null } |
  { 'Patent' : null } |
  { 'FiveFold' : null } |
  { 'FourFold' : null } |
  { 'Goliath' : null } |
...
export type Gender = { 'Male' : null } |
  { 'Female' : null };
export interface GetBetsDTO { 'principalId' : PrincipalId }
...
export type MatchResult = { 'HomeWin' : null } |
  { 'Draw' : null } |
  { 'AwayWin' : null };
export interface MissPenaltyOdds { 'homeTeam' : number, 'awayTeam' : number }
...
export interface OverUnderSelection { 'odds' : number, 'margin' : number }
...
export type PlayerPosition = { 'Goalkeeper' : null } |
  ...
  { 'Forward' : null } |
  { 'Defender' : null };
export interface PlayerSelectionOdds { 'playerId' : PlayerId, 'odds' : number }
...
export type Result_1 = { 'ok' : BetSlip } |
  { 'err' : Error };
export type Result_10 = { 'ok' : Array<LoanedPlayerDTO> } |
  { 'err' : Error };
export type Result_11 = { 'ok' : Array<FootballLeagueDTO> } |
  { 'err' : Error };
export type Result_12 = { 'ok' : LeagueStatus } |
  { 'err' : Error };
export type Result_13 = { 'ok' : Array<PlayerDTO> } |
  { 'err' : Error };
export type Result_14 = { 'ok' : Array<ClubDTO> } |
  { 'err' : Error };
export type Result_15 = { 'ok' : Array<FixtureDTO> } |
  { 'err' : Error };
export type Result_16 = { 'ok' : Array<DataHashDTO> } |
  { 'err' : Error };
export type Result_17 = { 'ok' : Array<DataHash> } |
  { 'err' : Error };
export type Result_18 = { 'ok' : Array<CountryDTO> } |
  { 'err' : Error };
export type Result_19 = { 'ok' : Array<HomePageFixtureDTO> } |
  { 'err' : Error };
export type Result_2 = { 'ok' : boolean } |
  { 'err' : Error };
export type Result_20 = { 'ok' : Array<BetSlip> } |
  { 'err' : Error };
export type Result_3 = { 'ok' : UserAuditDTO } |
  { 'err' : Error };
...
export type Result_8 = { 'ok' : PlayerDetailDTO } |
  { 'err' : Error };
export type Result_9 = { 'ok' : MatchOddsDTO } |
  { 'err' : Error };
...
export interface SystemStateDTO { 'version' : string, 'onHold' : boolean }
...
export interface YesNoSelectionOdds { 'noOdds' : number, 'yesOdds' : number }
export interface _SERVICE {
  ...
  'executeTransferPlayer' : ActorMethod<
    [LeagueId, TransferPlayerDTO],
    undefined
  >,
  'executeUnretirePlayer' : ActorMethod<
  ...
  'getFixtures' : ActorMethod<[LeagueId], Result_15>,
